...
import { setuser } from '../Tookit/userSlice';
        ...
        <MDBCol col='1'>
          <MDBCard className='bg-dark text-white mx-auto' style={{ borderRadius: '6rem', maxWidth: '400px',maxHeight:'800px', marginTop:'100px' }}>
            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
              ...
              <div>
                <p className="mb-0">Don't have an account? <a href="#!" className="text-white-50 fw-bold" onClick={() => setboxname("signup")} style={{ color: "blue" }}>Sign Up</a></p>
              </div>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
